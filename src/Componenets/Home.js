        ...
        <div>
            ...
            <div className='grid grid-cols-3 rounded-lg mt-2 bg-orange-300'>
                <div className='mt-3 mb-2 ml-5'>
                    <img src ={props.news[1]?.urlToImage}/>
                ...
                <div>
                <div className='mt-3 mb-2 ml-5'>
                    <img src ={props.news[3]?.urlToImage}/>
                    <h1 className='text-sm font-semibold mt-3 p-2 ml-2'>{props.news[3]?.title}</h1>
                    <h4>{props.news[3]?.content}</h4>
                </div>
                </div>
            </div>
            <div>
