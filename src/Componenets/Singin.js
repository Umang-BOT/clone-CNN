  ...
  return (
    <div className='bg-red-100 h-screen flex flex-col items-center justify-center'>
        <div className='bg-white p-8 rounded-lg w-4/12'>
            ...
            <h1 className='mt-3'>Already have account?<Link to="/login"><span className='underline'>Sign in</span></Link></h1>
            ...
            <button onClick={Signin} type="button" className="mt-3 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">Create Account</button>
        </div>
    </div>
  )
}
